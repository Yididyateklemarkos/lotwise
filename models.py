...
class User(UserMixin, db.Model):
    ...
    # Kept for compatibility with existing records and relationships. New
    # accounts use first_name/last_name as their display identity.
...
class Event(db.Model):
    """A Lotwise-hosted meeting or event managed by admins."""
